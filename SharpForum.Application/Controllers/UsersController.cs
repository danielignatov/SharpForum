namespace SharpForum.Application.Controllers
{
    ...
    using SharpForum.Models.ViewModels.Account;
    ...
    public class UsersController : Controller
    {
        ...
        public UsersController(UserManager userManager, ApplicationSignInManager signInManager )
            : base()
        {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new User {
                    ...
                    ForumSignature = model.ForumSignature,
                    RoleTitle = "User"
                };

                if (model.AboutMe == null)
                {
                    user.AboutMe = "The user has not set this information.";
                }

                if (model.AvatarUrl == null)
                {
                    user.AvatarUrl = "http://www.filecluster.com/howto/wp-content/uploads/2014/07/User-Default.jpg";
                }
