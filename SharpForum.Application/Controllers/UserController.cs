namespace SharpForum.Application.Controllers
{
    ...
    public class UserController : Controller
    {
        ...
        public UserController(UserManager userManager, ApplicationSignInManager signInManager )
            : base()
        {
        ...
        {
            if (!this.userService.DoesUserExist(uid))
            {
                return HttpNotFound();
            }

            UserViewModel viewModel = this.userService.GetUserViewModel(uid);
